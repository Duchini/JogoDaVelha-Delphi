...
uses
  ...
  Vcl.MPlayer, Vcl.ComCtrls, Vcl.Grids, Vcl.DBGrids, Unit3;
...
type
  TForm1 = class(TForm)
    ...
    procedure JogadoresEnter(Sender: TObject);
    procedure LigaCronometro();
...
procedure TForm1.JogadoresEnter(Sender: TObject);
begin
qsJogadores.Refresh;
end;
...
procedure TForm1.LigaCronometro();
var
seg, min: integer;
begin
...
var
   seg, min: integer;
begin
//<<Desliga o Replay caso esteja rodando
